...
积分明细不会自动清理。主动撤销后记录仍会保留，并显示撤销时间和原因，但不再参与学生总分、排行榜或导出统计。网页端通过各页面右上角的“操作日志”进入，默认查询当月，可按开始和结束日期筛选。
...
网页端进入“维度与积分项”，点击任一维度右侧的“统计”，选择开始和结束日期后可查看：
...
网页端进入“排行榜”，选择开始日期、结束日期和可选维度，点击“导出量化汇总及细则”。勾选“总分榜”时导出全部历史。
